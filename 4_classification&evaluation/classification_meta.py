...
df_bow = pd.read_csv(filepath_or_buffer='2_feature_extraction/output/req_meta_vectorized_bow.csv', header=0)
X_bow = df_bow.drop('_subclass_', axis=1)
y_bow = df_bow['_subclass_']

# import requirements data (BoW & Chi-Squared)
df_chi_bow_knn = pd.read_csv(filepath_or_buffer='3_dimensionality_reduction/output/req_meta_chi2/req_chi2_bow_knn.csv', header=0)
X_chi_bow_knn = df_chi_bow_knn.drop('_subclass_', axis=1)
y_chi_bow_knn = df_chi_bow_knn['_subclass_']

df_chi_bow_svm = pd.read_csv(filepath_or_buffer='3_dimensionality_reduction/output/req_meta_chi2/req_chi2_bow_svm.csv', header=0)
X_chi_bow_svm = df_chi_bow_svm.drop('_subclass_', axis=1)
y_chi_bow_svm = df_chi_bow_svm['_subclass_']

df_chi_bow_lr = pd.read_csv(filepath_or_buffer='3_dimensionality_reduction/output/req_meta_chi2/req_chi2_bow_lr.csv', header=0)
X_chi_bow_lr = df_chi_bow_lr.drop('_subclass_', axis=1)
y_chi_bow_lr = df_chi_bow_lr['_subclass_']

df_chi_bow_mnb = pd.read_csv(filepath_or_buffer='3_dimensionality_reduction/output/req_meta_chi2/req_chi2_bow_mnb.csv', header=0)
X_chi_bow_mnb = df_chi_bow_mnb.drop('_subclass_', axis=1)
y_chi_bow_mnb = df_chi_bow_mnb['_subclass_']

df_chi_bow_ensemble = pd.read_csv(filepath_or_buffer='3_dimensionality_reduction/output/req_meta_chi2/req_chi2_bow_ensemble.csv', header=0)
X_chi_bow_ensemble = df_chi_bow_ensemble.drop('_subclass_', axis=1)
y_chi_bow_ensemble = df_chi_bow_ensemble['_subclass_']

# import requirements data (BoW, Chi-Squared & PCA)
df_pca_bow_knn = pd.read_csv(filepath_or_buffer='3_dimensionality_reduction/output/req_meta_pca/req_pca_bow_knn.csv', header=0)
X_pca_bow_knn = df_pca_bow_knn.drop('_subclass_', axis=1)
y_pca_bow_knn = df_pca_bow_knn['_subclass_']

df_pca_bow_svm = pd.read_csv(filepath_or_buffer='3_dimensionality_reduction/output/req_meta_pca/req_pca_bow_svm.csv', header=0)
X_pca_bow_svm = df_pca_bow_svm.drop('_subclass_', axis=1)
y_pca_bow_svm = df_pca_bow_svm['_subclass_']

df_pca_bow_lr = pd.read_csv(filepath_or_buffer='3_dimensionality_reduction/output/req_meta_pca/req_pca_bow_lr.csv', header=0)
X_pca_bow_lr = df_pca_bow_lr.drop('_subclass_', axis=1)
y_pca_bow_lr = df_pca_bow_lr['_subclass_']

df_pca_bow_ensemble = pd.read_csv(filepath_or_buffer='3_dimensionality_reduction/output/req_meta_pca/req_pca_bow_ensemble.csv', header=0)
X_pca_bow_ensemble = df_pca_bow_ensemble.drop('_subclass_', axis=1)
y_pca_bow_ensemble = df_pca_bow_ensemble['_subclass_']

# import requirements data (TF-IDF without dimensionality reduction)
df_tfidf = pd.read_csv(filepath_or_buffer='2_feature_extraction/output/req_meta_vectorized_tfidf.csv', header=0)
X_tfidf = df_tfidf.drop('_subclass_', axis=1)
y_tfidf = df_tfidf['_subclass_']

# import requirements data (TF-IDF & Chi-Squared)
df_chi_tfidf_knn = pd.read_csv(filepath_or_buffer='3_dimensionality_reduction/output/req_meta_chi2/req_chi2_tfidf_knn.csv', header=0)
X_chi_tfidf_knn = df_chi_tfidf_knn.drop('_subclass_', axis=1)
y_chi_tfidf_knn = df_chi_tfidf_knn['_subclass_']

df_chi_tfidf_svm = pd.read_csv(filepath_or_buffer='3_dimensionality_reduction/output/req_meta_chi2/req_chi2_tfidf_svm.csv', header=0)
X_chi_tfidf_svm = df_chi_tfidf_svm.drop('_subclass_', axis=1)
y_chi_tfidf_svm = df_chi_tfidf_svm['_subclass_']

df_chi_tfidf_lr = pd.read_csv(filepath_or_buffer='3_dimensionality_reduction/output/req_meta_chi2/req_chi2_tfidf_lr.csv', header=0)
X_chi_tfidf_lr = df_chi_tfidf_lr.drop('_subclass_', axis=1)
y_chi_tfidf_lr = df_chi_tfidf_lr['_subclass_']

df_chi_tfidf_mnb = pd.read_csv(filepath_or_buffer='3_dimensionality_reduction/output/req_meta_chi2/req_chi2_tfidf_mnb.csv', header=0)
X_chi_tfidf_mnb = df_chi_tfidf_mnb.drop('_subclass_', axis=1)
y_chi_tfidf_mnb = df_chi_tfidf_mnb['_subclass_']

df_chi_tfidf_ensemble = pd.read_csv(filepath_or_buffer='3_dimensionality_reduction/output/req_meta_chi2/req_chi2_tfidf_ensemble.csv', header=0)
X_chi_tfidf_ensemble = df_chi_tfidf_ensemble.drop('_subclass_', axis=1)
y_chi_tfidf_ensemble = df_chi_tfidf_ensemble['_subclass_']

# import requirements data (TF-IDF, Chi-Squared & PCA)
df_pca_tfidf_knn = pd.read_csv(filepath_or_buffer='3_dimensionality_reduction/output/req_meta_pca/req_pca_tfidf_knn.csv', header=0)
X_pca_tfidf_knn = df_pca_tfidf_knn.drop('_subclass_', axis=1)
y_pca_tfidf_knn = df_pca_tfidf_knn['_subclass_']

df_pca_tfidf_svm = pd.read_csv(filepath_or_buffer='3_dimensionality_reduction/output/req_meta_pca/req_pca_tfidf_svm.csv', header=0)
X_pca_tfidf_svm = df_pca_tfidf_svm.drop('_subclass_', axis=1)
y_pca_tfidf_svm = df_pca_tfidf_svm['_subclass_']

df_pca_tfidf_lr = pd.read_csv(filepath_or_buffer='3_dimensionality_reduction/output/req_meta_pca/req_pca_tfidf_lr.csv', header=0)
X_pca_tfidf_lr = df_pca_tfidf_lr.drop('_subclass_', axis=1)
y_pca_tfidf_lr = df_pca_tfidf_lr['_subclass_']

df_pca_tfidf_ensemble = pd.read_csv(filepath_or_buffer='3_dimensionality_reduction/output/req_meta_pca/req_pca_tfidf_ensemble.csv', header=0)
X_pca_tfidf_ensemble = df_pca_tfidf_ensemble.drop('_subclass_', axis=1)
y_pca_tfidf_ensemble = df_pca_tfidf_ensemble['_subclass_']
...
df_evaluation_metrics.to_excel('4_classification&evaluation/output/meta_subclasses/evaluation_metrics.xlsx')
df_evaluation_time.to_excel('4_classification&evaluation/output/meta_subclasses/evaluation_time.xlsx')
