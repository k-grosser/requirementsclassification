...
df_evaluation_metrics.to_excel('4_classification&evaluation/output/without_context_integration/evaluation_metrics.xlsx')
df_evaluation_time.to_excel('4_classification&evaluation/output/without_context_integration/evaluation_time.xlsx')
df_evaluation_labels.to_excel('4_classification&evaluation/output/without_context_integration/evaluation_labels.xlsx')

df_precision_standard_deviations.to_excel('4_classification&evaluation/output/without_context_integration/evaluation_precision_standard_deviation.xlsx')
df_recall_standard_deviations.to_excel('4_classification&evaluation/output/without_context_integration/evaluation_recall_standard_deviation.xlsx')
df_f1_standard_deviations.to_excel('4_classification&evaluation/output/without_context_integration/evaluation_f1_standard_deviation.xlsx')
