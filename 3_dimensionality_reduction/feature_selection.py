...
select_features(df_bow, 300).to_csv('3_dimensionality_reduction/output/req_chi2_bow.csv', index=False)
select_features(df_tfidf, 350).to_csv('3_dimensionality_reduction/output/req_chi2_tfidf.csv', index=False)
